...
describe('Comment e2e test', () => {
  ...
  it('should create and save Comments', async () => {
    ...
    await promise.all([
      ...
      commentUpdatePage.setCreatedDateInput('2000-12-31'),
    ...
    expect(await commentUpdatePage.getCreatedDateInput()).to.eq('2000-12-31', 'Expected createdDate value to be equals to 2000-12-31');
